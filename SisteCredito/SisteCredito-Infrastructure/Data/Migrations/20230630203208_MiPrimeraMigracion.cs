        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GeneroId = table.Column<int>(type: "int", nullable: false),
                    Cargo = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    UsuarioHabilitado = table.Column<bool>(type: "bit", nullable: true),
                    Mail = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AreasId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Empleados_Areas_AreasId",
                        column: x => x.AreasId,
                        principalTable: "Areas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Empleados_Lideres_LiderId",
                        column: x => x.LiderId,
                        principalTable: "Lideres",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AprobadoPorLider = table.Column<bool>(type: "bit", nullable: false),
                    AprobadoPorTalentoHumano = table.Column<bool>(type: "bit", nullable: false),
                    AprobadoPorGerencia = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_reporteHorasExtras", x => x.Id);
                    table.ForeignKey(
                        name: "FK_reporteHorasExtras_Empleados_EmpleadoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Empleados_LiderId",
                table: "Empleados",
                column: "LiderId");

            migrationBuilder.CreateIndex(
                name: "IX_Lideres_AreasId",
                table: "Lideres",
                column: "AreasId");

            migrationBuilder.CreateIndex(
                name: "IX_reporteHorasExtras_EmpleadoId",
